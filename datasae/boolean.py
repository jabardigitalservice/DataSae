...
class Boolean(Basic):
    def __init__(self, dataFrame: pd.DataFrame):
        """
        Initializes an instance of the Boolean class.
    ...
    def check_bool(bool_data: bool):
        ...
        if isinstance(bool_data, bool):
            ...
            warning_data = {
                ...
                "value": bool_data,
                "detail_message": ("Value should be boolean (True or False)"),
            }
    ...
    def is_bool(self, column: str) -> dict:
        ...
        for index, bool_data in enumerate(self.dataFrame[column]):
            try:
                ...
                valid, invalid, warning_data = self.check_bool(
                    bool_data
                )
                valid += valid
                invalid += invalid
                ...
                invalid += 1
                warning_data = {
                    "message": "Invalid Data Tyoe",
                    "value": bool_data,
                    "detail_message": "Value must be of boolean data type",
                }
    ...
    def check_is_in(bool_data, is_in: list):
        ...
        if bool_data in is_in:
            ...
            warning_data = {
                "message": "Invalid Value",
                "value": bool_data,
                "detail_message": (f"Value should be one of the list {is_in}"),
            }
        return valid, invalid, warning_data
        ...
        for index, bool_data in enumerate(self.dataFrame[column]):
            try:
                ...
                warning_data = {
                    ...
                    "value": bool_data,
                    "detail_message": "Value must be of defined boolean list",
                }
                warning[index] = InvalidDataTypeWarning(warning_data).message
